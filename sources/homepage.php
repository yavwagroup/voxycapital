 <!-- Page Title-->
			 ...
			 <div class="tab_filters">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 filters pull-right filter-category">
                            <ul class="nav nav-pills">
                                      <li class="web-designer"><a href="<?php echo $settings['url']; ?>buy-bitcoins-PayPal">PayPal</a></li>
                                      <li class="fianance"><a href="<?php echo $settings['url']; ?>buy-bitcoins-Perfect-Money">Perfect Money</a></li>
                                      <li class="education"><a href="<?php echo $settings['url']; ?>buy-bitcoins-Payeer">Payeer</a></li>
                                      <li class="food-service"><a href="<?php echo $settings['url']; ?>buy-bitcoins-Skrill">Skrill</a></li>
                                      <li class="health-services"><a href="<?php echo $settings['url']; ?>buy-bitcoins-Neteller">Neteller</a></li>
                                      <li class="automative"><a href="<?php echo $settings['url']; ?>buy-bitcoins-AdvCash">AdvCash</a></li>
									  <li class="automative"><a href="<?php echo $settings['url']; ?>buy-bitcoins-Bank-Transfer">Bank Transfer</a></li>
                                      <li class="all"><a href="<?php echo $settings['url']; ?>buy-bitcoins">All</a></li>
                            </ul>
                        </div>
                 </div>
          		<div class="jobs-result"> 
                        ...
                        <div class="jobs list-style2">
							<?php
							$query = $db->query("SELECT * FROM btc_ads WHERE type='sell' ORDER BY RAND() LIMIT 10");
							$querynums = $query->num_rows;
								if($query->num_rows>0) {
							...
							<?php if($querynums>10) { ?>
                            <div class="col-lg-12">
                            <a href="<?php echo $settings['url']."buy-bitcoins"; ?>" class="btn btn-default" id="load_more" style="max-width:250px;"> <?php echo $lang['show_more_ads']; ?> <span class="glyphicon glyphicon-menu-down"></span></a></div>               
                            <?php } ?>
                         </div> 
                         <!--Search Result 01-->
                    </div>
    	...
    	<div class="container-fluid bluesection">
        	...
        	<div class="container main-container">
            	<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 blue-halef">
                	<h3><?php echo $lang['why_us']; ?></h3>
                    <p><?php echo $lang['why_us_answer']; ?></p>
            ...
            <div class="container main-container countjobs" id="cjobs">
            	<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                	   <ul id="counter">
                       		<li><div class="count"><div class="num"><?php $numsquery = $db->query("SELECT * FROM btc_ads"); echo $numsquery->num_rows; ?></div></div><span><?php echo $lang['advertisements']; ?></span></li>
                            <li><div class="count"><div class="num"><?php $numsquery = $db->query("SELECT * FROM btc_trades"); echo $numsquery->num_rows; ?></div></div><span><?php echo $lang['trades']; ?></span></li>
                            <li><div class="count"><div class="num"><?php $numsquery = $db->query("SELECT * FROM btc_users"); echo $numsquery->num_rows; ?></div></div><span><?php echo $lang['users']; ?></span></li>
    ...
    <!---full width sectio fulid-->
		...
		<div class="row">
			 ...
			 <div class="tab_filters">
                        <div class="col-lg-4">
                            <h5><?php echo $lang['sell_bitcoins']; ?></h5>
                         </div>
                        
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 filters pull-right filter-category">
                            <ul class="nav nav-pills">
                                      <li class="web-designer"><a href="<?php echo $settings['url']; ?>sell-bitcoins-PayPal">PayPal</a></li>
                                      <li class="fianance"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Perfect-Money">Perfect Money</a></li>
                                      <li class="education"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Payeer">Payeer</a></li>
                                      <li class="food-service"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Skrill">Skrill</a></li>
                                      <li class="health-services"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Neteller">Neteller</a></li>
                                      <li class="automative"><a href="<?php echo $settings['url']; ?>sell-bitcoins-AdvCash">AdvCash</a></li>
									  <li class="automative"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Bank-Transfer">Bank Transfer</a></li>
                                      <li class="all"><a href="<?php echo $settings['url']; ?>sell-bitcoins">All</a></li>
                            </ul>
                        </div>
                 </div>
          		<div class="jobs-result"> 
                        ...
                        <div class="jobs list-style2">
							<?php
							$query = $db->query("SELECT * FROM btc_ads WHERE type='buy' ORDER BY RAND() LIMIT 10");
							$querynums = $query->num_rows;
								if($query->num_rows>0) {
									while($row = $query->fetch_assoc()) {
										$pm = str_ireplace(" ","-",$row['payment_method']);
                       		...
                       		<div class="filter-result 01">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="desig">
										...
										<span class="pull-right">
										 <a href="<?php echo $settings['url'];?>ad/Bitcoin-to-<?php echo $pm; ?>/<?php echo $row['id']; ?>"><span class="label job-type job-contract "><?php echo $lang['btn_sell']; ?></span></a>
                                    </span>
                                    </div>
                            ...
                            <?php if($querynums>10) { ?>
                            <div class="col-lg-12">
                            <a href="<?php echo $settings['url']."sell-bitcoins"; ?>" class="btn btn-default" id="load_more" style="max-width:250px;"> <?php echo $lang['show_more_ads']; ?> <span class="glyphicon glyphicon-menu-down"></span></a></div>               
                            <?php } ?>              
