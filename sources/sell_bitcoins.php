			 ...
			 <div class="tab_filters">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 filters pull-right filter-category">
                            <ul class="nav nav-pills">
                                      <li class="web-designer <?php if($_GET['pm'] == "PayPal") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-PayPal">PayPal</a></li>
                                      <li class="fianance <?php if($_GET['pm'] == "Perfect-Money") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Perfect-Money">Perfect Money</a></li>
                                      <li class="education <?php if($_GET['pm'] == "Payeer") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Payeer">Payeer</a></li>
                                      <li class="food-service <?php if($_GET['pm'] == "Skrill") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Skrill">Skrill</a></li>
                                      <li class="health-services <?php if($_GET['pm'] == "Neteller") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Neteller">Neteller</a></li>
                                      <li class="automative <?php if($_GET['pm'] == "AdvCash") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-AdvCash">AdvCash</a></li>
									  <li class="automative <?php if($_GET['pm'] == "Bank-Transfer") { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins-Bank-Transfer">Bank Transfer</a></li>
                                      <li class="all <?php if(!$_GET['pm']) { echo 'active'; } ?>"><a href="<?php echo $settings['url']; ?>sell-bitcoins">All</a></li>
                            </ul>
                        </div>
                 </div>
          		<div class="jobs-result"> 
						...
						<?php
								...
								$statement = "btc_ads WHERE type='buy' $qadd";
							...
							if(isset($_GET['pm'])) {
								$pm = protect($_GET['pm']);
								$ver = $settings['url']."sell-bitcoins-$pm";
							} else {
								$ver = $settings['url']."sell-bitcoins";
							}
